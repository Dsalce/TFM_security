# -*- coding: utf-8 -*-
"""
Created on Tue Jun  9 19:37:59 2020
...
class WhatVirtualization(object):
    
   def __init__(self):
       pass
       
   def cpuHypervisorID(self):
   ...
   def findHypervisor(self):
    name = 'no virtual'
    try:
        hid = self.cpuHypervisorID()
        if hid == 'VMwareVMware':
            name = 'vmware'
            ...
            name = 'kvm'
        elif 'QEMU' in self.cpuModelName():
            name = 'qemu'
...
if __name__ == '__main__':
    ...
    wV=WhatVirtualization()
    print(wV.cpuHypervisorID())
    print( wV.findHypervisor())
